...
simulatorName_to_entityId = {
    ...
    "Gate-1": 'b4049f6f-2224-4ef8-b3e5-5e9b9136d66b',
    "Gate-2": '00f01643-9672-46be-bc33-94b83d8f0865',
    "Escalator1": '5f6bae83-1954-420a-ab19-8162800fa529',
    "Escalator2": '8573db7b-c03c-41f4-943e-f57addba9677',
    "SolarPanels1": 'a6638173-8ffa-4653-b329-e1be7112d4dd',
    ...
    "Arrival": 'a31d3c52-b5fe-492f-9bec-5617646d6cc2',
    ...
    "Ready": 'f79de777-59ca-41d4-b99d-383c1da1f765'
}
def remap_ids(row):
